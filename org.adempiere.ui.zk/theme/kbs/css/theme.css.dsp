...
html,body {
	...
	color: #333;
	font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', 'Microsoft YaHei New', 'Microsoft Yahei', 'Î¢ÈíÑÅºÚ', 'ËÎÌå', 'SimSun', 'STXihei', '»ªÎÄÏ¸ºÚ', sans-serif;
	overflow: hidden;
}
