	...
	<div id="body" class="body">
		...
		<div id ="main" class="main">
			<div id="main-content" class="main-content">
				...
				<div id="main-applogin" class="main-applogin">
					<a href="<%=Prop.getProperty(Prop.APPLOGIN_LINK)%>" target="_self">
						<img name="img_applogin" src="<%=Prop.getImage("img_applogin-64px.png")%>" border="0" title="<%=Prop.getProperty(Prop.APPLOGIN_TEXT)%>"/>
					</a>
				</div>
